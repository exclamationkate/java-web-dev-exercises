...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Chocolate Sauce", 0.50, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping2 = new Topping("Chopped Nuts", 0.35, new ArrayList<>(Arrays.asList( "nuts")));
        Topping topping3 = new Topping("Cherries", 0.65, new ArrayList<>(Arrays.asList( "cherry", "gelatin")));
